        ...
        <motion.div className={styles.content} {...historyAnimations}>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.list__item}>
              <SnowflakeIcon />
              <p>
                Проект создан в рамках хакатона «ИТ-вызов» силами команды
                “Перфоратор” и ее участников: Владислава Корепанова, Анны
                Четкаревой, Романа Макарова и Владислава Иванова.
              </p>
            </li>
          </ul>
        </motion.div>
